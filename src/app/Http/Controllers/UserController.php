...
class UserController extends Controller
{
    ...
    {
        $authuser = auth()->user();
        $follows = Follow::where('follow_user_id', auth()->user()->id)->get();
    ...
    {
        return Follow::all()->where('follow_user_id', $userId)->count();
        //
    }
    ...
    {
        return Follow::all()->where('follower_user_id', $userId)->count();
        //
    }
